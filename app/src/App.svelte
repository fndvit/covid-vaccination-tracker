...
<main>
  ...
  <div class="title">
    <h1>
      A este ritmo, España completa la primera fase de la vacunación contra la
      COVID-19 <strong>a {approxDate(spainData.dateComplete)}</strong>
    </h1>
    <img
      class="icon"
  ...
  <p class="text summary">
    ...
    de vacunas (de <em>Pfizer</em> y <em>Moderna</em>). Con esas dosis se puede
    vacunar a {loc.format(",.2r")(totalVacc / 1e6 / 2)} millones de personas; cada
    vacuna necesita dos dosis administradas con unas semanas de diferencia para completar
    la pauta de tratamiento. En la primera fase, se prevé vacunar a 2,4 millones:
    mayores en residencias, personas con un gran grado de dependencia y sanitarios.
  </p>
  <p class="text summary">
    Desde el 9 de febrero los datos incluyen las dosis de AstraZeneca con las
    que se vacunará al personal sanitario y sociosanitario en activo —hasta los
    55 años de edad— que no estuviera incluido hasta ahora.
  </p>
  <p class="text summary">
